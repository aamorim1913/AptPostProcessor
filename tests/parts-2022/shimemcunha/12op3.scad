...
l=1.000000; ltool=60.000000; rtool=1.200000;
...
/* line -> 41 */
color("blue",0.3) translate([xd,yd,zd]) hull(){translate([14.43,4.00,25.00]) cylinder(1,rtool,rtool); translate([14.43,4.00,25.00]) cylinder(1,rtool,rtool);}
color("green",0.3) translate([xd,yd,zd]) translate([14.43,4.00,-3.10]) cylinder(28.10,rtool,rtool);
x=-178.645;y=-102.216;z=34.899; /* Near the table */
