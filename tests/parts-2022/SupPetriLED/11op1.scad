...
color("green",0.3) translate([xd,yd,zd]) translate([59.50,99.50,-27.30]) cylinder(52.30,rtool,rtool);
/* line -> 31 */
...
color("green",0.3) translate([xd,yd,zd]) translate([24.86,79.50,-27.30]) cylinder(52.30,rtool,rtool);
/* line -> 32 */
...
color("green",0.3) translate([xd,yd,zd]) translate([24.86,39.50,-27.30]) cylinder(52.30,rtool,rtool);
/* line -> 33 */
...
color("green",0.3) translate([xd,yd,zd]) translate([59.50,19.50,-27.30]) cylinder(52.30,rtool,rtool);
/* line -> 34 */
...
color("green",0.3) translate([xd,yd,zd]) translate([94.14,39.50,-27.30]) cylinder(52.30,rtool,rtool);
/* line -> 35 */
...
color("green",0.3) translate([xd,yd,zd]) translate([94.14,79.50,-27.30]) cylinder(52.30,rtool,rtool);
