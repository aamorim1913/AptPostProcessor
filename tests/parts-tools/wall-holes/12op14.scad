...
l=0.000000; ltool=181.000000; rtool=8.250000;
...
color("green",0.3) translate([xd,yd,zd]) translate([30.00,-25.00,-54.95]) cylinder(79.95,rtool,rtool);
...
color("brown",0.25) translate([-49.340000,-6.216400,138.384100]) cube([500.000000,400.000000,400.000000],center=true);
